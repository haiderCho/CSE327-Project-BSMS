                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form role="form" action="process_book_edit.php" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                                ...
                                                ?>
                                    <input type="text" name="bnm" value="<?php echo $crow['b_nm'] ?>"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                                ...
                                                ?>
                                    <input type="text" name="price" value="<?php echo $crow['b_price'] ?>"
                                        class="form-control">
                                </div>
